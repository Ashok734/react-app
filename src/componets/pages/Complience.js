      ...
      <section id="signup-wrapper">
        <div className="container">
          <div className="row g-5">
            ...
            <h3>Worry-free bussiness complience. what a relief</h3>
            ...
            <div className="row g-0">
             ...
             <div className="row g-0">
                ...
                <div className="compare">
                    <NavLink to="/setup" type="submit" className="btn btn-secondary mt-4"><i className="fas fa-arrow-left"></i> </NavLink>
                    <NavLink to="/annualtax" type="submit" className="btn btn-dark mt-4 next">NEXT <i className="fas fa-arrow-right"></i> </NavLink>
             </div>
              </div>
